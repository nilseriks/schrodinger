...
sys.path.insert(0, os.path.abspath('../calculus'))
...
project = 'Schrodinger'
copyright = '2020, Nils-Erik Schütte & Jan-Luca Hubald'
author = 'Nils-Erik Schütte & Jan-Luca Hubald'
...
latex_documents = [
    (master_doc, 'Schrodinger.tex', 'Schrodinger Documentation',
     'Nils-Erik Schütte \\& Jan-Luca Hubald', 'manual'),
]
